...
namespace SCM.Presentation
{
	...
	{
		private DataTable dt = new DataTable("SCM_AUT_USER");
		...
		public void InitData()
		{
			...
			cboURoleID.DisplayMember = "UROLE_ID";
		...
		private void btnDelete_Click(object sender, System.EventArgs e)
		{
            ...
            // User can not delete themselves
            if (clsSystemConfig.UserName.ToLower() == username.ToLower())
            {
                MessageBox.Show("You can not delete your account, \n please choose another one.", "Message",
...
//			string status = ((DataRowView)cboStatus.SelectedItem)["Value"].ToString();
			string roleID = cboURoleID.Text.Trim();
