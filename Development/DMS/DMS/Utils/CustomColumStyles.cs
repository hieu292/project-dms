...
namespace DMS.Utils
{
		...
		{
			public event FormatCellEventHandler SetCellFormat;
			public event FormatGetSizeHandler GetSizeCell;
		...
		#endregion
	#region GetSize Event

	public delegate void FormatGetSizeHandler(object sender, DataGridGetSizeCellEventArgs e);

	public class DataGridGetSizeCellEventArgs : EventArgs
	{
		private Rectangle m_recBound;
		public DataGridGetSizeCellEventArgs(Rectangle recBound)
		{
			m_recBound = recBound;
		}
		public Rectangle RecBound
		{
			get{ return m_recBound;}
		}
	}
	#endregion
