...
namespace DMS.Utils
{
	...
	public class clsStyleManager
	{
		...
		public static void Init()
		{
			try
			{
				...
				if( str == Style.Blue.ToString() )
				{
                    ...
                    filename = clsSystemConfig.ImageFolder + "SCM_bg_button_style.png";
				}
				...
				else if( str == Style.Maveric.ToString() )
				{
                    ...
                    filename = clsSystemConfig.ImageFolder + "SCM_button.png";
				}
		...
		public static void SetStyle(Control control)
		{
            ...
            //++PhatLT Add
            Form frmForm = control as Form;
            if (frmForm != null)
            {
                frmForm.BackColor = Color.FromArgb(217, 232, 252);
            }
            //--PhatLT Add
			if(lbl != null)
			{
